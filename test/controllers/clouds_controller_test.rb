...
class CloudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloud" do
    assert_difference('Cloud.count') do
      post clouds_url, params: { cloud: { image_id: @cloud.image_id, post_id: @cloud.post_id, tag_id: @cloud.tag_id } }
    end
  ...
  test "should update cloud" do
    patch cloud_url(@cloud), params: { cloud: { image_id: @cloud.image_id, post_id: @cloud.post_id, tag_id: @cloud.tag_id } }
